...
$(MAIN) : build/$(MAIN).o build/gliby/Batch.o build/gliby/ShaderManager.o build/gliby/Frame.o build/gliby/Math3D.o build/gliby/Frustum.o build/gliby/MatrixStack.o build/gliby/TransformPipeline.o build/gliby/Actor.o build/gliby/TriangleBatch.o build/gliby/GeometryFactory.o
	$(CC) -o $(MAIN) $^ $(LIBS)
